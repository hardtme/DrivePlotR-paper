...
abstract: >
  We introduce the DrivePlotR R package, an interactive visualization tool that produces linked plot maps for multivariate high resolution spatio-temporal data, such as data from naturalistic driving studies and connected vehicles. Such interactive visualizations simplify the data analysis process by allowing users to explore the spatial, temporal, and multivariate aspects of the data simultaneously with one plot map. We describe the architecture of the package, provide example use cases, and suggest future extensions.
draft: true
author:  
  - name: Marie Hardt
