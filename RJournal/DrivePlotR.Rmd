...
```{r accel, fig.cap="A likely unproblematic acceleration event detected during part of a drive from a naturalistic driving study."}
# 
...
```{r functions, fig.cap="The relationship between the DrivePlotR functions. The function driveplot calls both driveplot\\_map and driveplot\\_companions.  The function driveplot\\_companions calls driveplot\\_companion to create each companion graph for the stack."}
