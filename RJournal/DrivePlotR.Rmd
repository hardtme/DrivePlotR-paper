...
We give a detailed description of the implementation of \pkg{DrivePlotR} and also discuss all the components in Figure \@ref(fig:teaser). Then, we highlight some use cases of \pkg{DrivePlotR} and demonstrate a typical \pkg{DrivePlotR} workflow. Lastly, we discuss possible extensions for future versions of \pkg{DrivePlotR}.
