...
The interface of \pkg{DrivePlotR} visualizations consists of four components: (1) a map, (2) companion graph(s), (3) the infrastructure linking the visuals and enabling the interactivity, and (4) the non-standard evaluation used within the functions. Users can see the first two components through the interactive plot maps produced by \pkg{DrivePlotR}. The third and fourth components exist within the package code. Although invisible to the user, the infrastructure is the key component that controls the linked interactive plots. Therefore, that infrastructure is described first, followed by a discussion of the creation of the map and the companion graph(s).
