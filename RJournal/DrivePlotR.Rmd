...
ii. Establish the geographic variables and projection. Setting the geographic projection to WGS84 ensures that points in the data line up with maps in Leaflet. This is already done for the example dataset `drive7` included with \pkg{DrivePlotR}. Users may find that using functions from \CRANpkg{sf} makes this process easier, but \CRANpkg{sf} is not required to use \pkg{DrivePlotR}.
